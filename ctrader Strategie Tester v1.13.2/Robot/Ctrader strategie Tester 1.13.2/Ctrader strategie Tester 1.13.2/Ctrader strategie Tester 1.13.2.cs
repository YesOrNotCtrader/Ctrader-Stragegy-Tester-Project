...
namespace cAlgo.Robots
{
    ...
    public class CtraderStrategieTesterv11 : Robot
    {
        ...
        private int GetBasline1(TradeType tradeType) // all indicator adding on baseline are implemented here
        {
            ...
            if ((resultBaseline1P == 1) && (resultBaseline2P == 1) && (resultBaseline4P == 1)) // add all variable with this sentence (exemple): (!Volume1MfiUse || resultMfi == 1)
                return 1;
            else if ((resultBaseline1P == -1) && (resultBaseline2P == -1) && (resultBaseline4P == -1))
                return -1;
            else
                return 0;
        }
        private int GetEntry1(TradeType tradeType) // all indicator adding on entry are implemented here
        {
            ...
            var resultEntry1P4 = !Entry1UseP4 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalCrossEnter(tradeType, entry1P4.Result, entry1P4.Signal, Entry1SignalTypeP4, Entry1LevelBuyP4, Entry1LevelSellP4, Entry1LookBackMinP4); //FunctionSignalCrossEnter(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     // without Entry
            if ((resultEntry1P1 == 1) && (resultEntry1P2 == 1) && (resultEntry1P4 == 1)) // add all variable with this sentence (exemple): (!Entry1RsiUse || resultRsi == 1)
                return 1;
            else if ((resultEntry1P1 == -1) && (resultEntry1P2 == -1) && (resultEntry1P4 == -1))
                return -1;
            else
                return 0;
        }
        ...
        private int GetConfirmation1(TradeType tradeType) // all indicator adding on confirmation are implemented here
        {
            ...
            var resultConfirmation1P4 = !Confirmation1UseP1 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalDoubleSignalUnderOver(tradeType, confirmation1P4.Result, confirmation1P4.Signal, Confirmation1SignalTypeP4, Confirmation1LevelBuyP4, Confirmation1LevelSellP4); //FunctionSignalCross(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)

            if ((resultConfirmation1P1 == 1) && (resultConfirmation1P2 == 1) && (resultConfirmation1P4 == 1)) // add all variable with this sentence : (!Confirmation1MacdUse || resultMacd == 1)
                return 1;
            else if ((resultConfirmation1P1 == -1) && (resultConfirmation1P2 == -1) && (resultConfirmation1P4 == -1))
                return -1;
            else
                return 0;
        }
        ...
        private int GetVolume1(TradeType tradeType) // all indicator adding on volume are implemented here
        {
            ...
            if ((resultVolume1P4 == 1) && (resultVolume2P4 == 1) && (resultVolume3P4 == 1))  // add all variable with this sentence : (!Volume1MfiUse || resultMfi == 1)
                return 1;
            else if ((resultVolume1P4 == -1) && (resultVolume2P4 == -1) && (resultVolume3P4 == -1))
                return -1;
            else
                return 0;
        }
