...
namespace cAlgo.Robots
{
    ...
    public class CtraderStrategieTesterv11 : Robot
    {
        ...
        [Parameter("     Level Buy", DefaultValue = -0.0005, Group = "B1  => Indicator 4 parametter", Step = 1)]
        public double Baseline1LevelBuyP4 { get; set; }
        [Parameter("     Level Sell", DefaultValue = 0.0005, Group = "B1  => Indicator 4 parametter", Step = 1)]
        ...
        [Parameter("     LookBack Min", DefaultValue = 2, MinValue = 1, Group = "E1  => Indicator 4 parametter", Step = 1)]
        ...
        [Parameter("     Level Buy", DefaultValue = -0.0005, Group = "C1  => Indicator 4 parametter", Step = 1)]
        public double Confirmation1LevelBuyP4 { get; set; }
        [Parameter("     Level Sell", DefaultValue = 0.0005, Group = "C1  => Indicator 4 parametter", Step = 1)]
        ...
        [Parameter("     Level Buy", DefaultValue = -0.0005, Group = "V1  => Indicator 4 parametter", Step = 1)]
        public double Volume1LevelBuyP4 { get; set; }
        [Parameter("     Level Sell", DefaultValue = 0.0005, Group = "V1  => Indicator 4 parametter", Step = 1)]
        ...
        [Parameter("     Level Buy", DefaultValue = -0.0005, Group = "V2  => Indicator 4 parametter", Step = 1)]
        public double Volume2LevelBuyP4 { get; set; }
        [Parameter("     Level Sell", DefaultValue = 0.0005, Group = "V2  => Indicator 4 parametter", Step = 1)]
        ...
        [Parameter("     Level Buy", DefaultValue = -0.0005, Group = "V3  => Indicator 4 parametter", Step = 1)]
        public double Volume3LevelBuyP4 { get; set; }
        [Parameter("     Level Sell", DefaultValue = 0.0005, Group = "V3  => Indicator 4 parametter", Step = 1)]
        ...
        public CSTP_Indi_1Parametter.EnumIndiSelection Exit1IndiCalculationSelectionP1 { get; set; }
        [Parameter("     Value1", DefaultValue = 55, Group = "Ex1  => Stop Loss Calculation", Step = 1)]
        public double Exit1IndiCalculationValue1P1 { get; set; }
        ...
        public CSTP_Indi_2Parametter.EnumIndiSelection Exit1IndiCalculationSelectionP2 { get; set; }
        [Parameter("     Value1", DefaultValue = 13, Group = "Ex1  => Stop Loss Calculation", Step = 1)]
        public double Exit1IndiCalculationValue1P2 { get; set; }
        [Parameter("     Value2", DefaultValue = 3, Group = "Ex1  => Stop Loss Calculation", Step = 1)]
        public double Exit1IndiCalculationValue2P2 { get; set; }
        ...
        public CSTP_Indi_4Parametter.EnumIndiSelection Exit1IndiCalculationSelectionP4 { get; set; }
        [Parameter("     Value1", DefaultValue = 13, Group = "Ex1  => Stop Loss Calculation", Step = 1)]
        public double Exit1IndiCalculationValue1P4 { get; set; }
        [Parameter("     Value2", DefaultValue = 1, Group = "Ex1  => Stop Loss Calculation", Step = 1)]
        public double Exit1IndiCalculationValue2P4 { get; set; }
        [Parameter("     Value3", DefaultValue = 1, Group = "Ex1  => Stop Loss Calculation", Step = 1)]
        public double Exit1IndiCalculationValue3P4 { get; set; }
        [Parameter("     MaType", DefaultValue = MovingAverageType.Simple, Group = "Ex1  => Stop Loss Calculation")]
        public MovingAverageType Exit1IndiCalculationMaTypeP4 { get; set; }
        ...
        public EnumExit1IndiTraillingType Exit1IndiTraillingType { get; set; }
        ...
        public double Exit1IndiTraillingStart { get; set; }
        ...
        public CSTP_Indi_1Parametter.EnumIndiSelection Exit1IndiTraillingSelectionP1 { get; set; }
        [Parameter("     Value1", DefaultValue = 55, Group = "Ex1  => Trailling Stop Setting", Step = 1)]
        public double Exit1IndiTraillingValue1P1 { get; set; }
        ...
        public CSTP_Indi_2Parametter.EnumIndiSelection Exit1IndiTraillingSelectionP2 { get; set; }
        [Parameter("     Value1", DefaultValue = 13, Group = "Ex1  => Trailling Stop Setting", Step = 1)]
        public double Exit1IndiTraillingValue1P2 { get; set; }
        [Parameter("     Value2", DefaultValue = 3, Group = "Ex1  => Trailling Stop Setting", Step = 1)]
        public double Exit1IndiTraillingValue2P2 { get; set; }
        ...
        public CSTP_Indi_4Parametter.EnumIndiSelection Exit1IndiTraillingSelectionP4 { get; set; }
        [Parameter("     Value1", DefaultValue = 13, Group = "Ex1  => Trailling Stop Setting", Step = 1)]
        public double Exit1IndiTraillingValue1P4 { get; set; }
        [Parameter("     Value2", DefaultValue = 1, Group = "Ex1  => Trailling Stop Setting", Step = 1)]
        public double Exit1IndiTraillingValue2P4 { get; set; }
        [Parameter("     Value3", DefaultValue = 1, Group = "Ex1  => Trailling Stop Setting", Step = 1)]
        public double Exit1IndiTraillingValue3P4 { get; set; }
        [Parameter("     MaType", DefaultValue = MovingAverageType.Simple, Group = "Ex1  => Trailling Stop Setting")]
        public MovingAverageType Exit1IndiTraillingMaTypeP4 { get; set; }


        //--------------------------------Optimisation--------------------------------------------------------------//
        [Parameter("Ratio Win / Loss", DefaultValue = false, Group = "============================================================================\nBACKTEST SETTING\n============================================================================\nGet Fitness Parametters")]
        public bool RatioWin { get; set; }
        [Parameter("Drawdown Max", DefaultValue = false, Group = "============================================================================\nBACKTEST SETTING\n============================================================================\nGet Fitness Parametters")]
        public bool DrawdownMax { get; set; }
        ...
        private CSTP_Indi_1Parametter exit1P1;
        private CSTP_Indi_2Parametter exit1P2;
        private CSTP_Indi_4Parametter exit1P4;
        ...
        protected override void OnStart()
        {
            ...
            //exit
            exit1P1 = Indicators.GetIndicator<CSTP_Indi_1Parametter>(MarketData.GetBars(Exit1TimeFrame), Exit1IndiCalculationSelectionP1, Exit1IndiCalculationValue1P1);
            exit1P2 = Indicators.GetIndicator<CSTP_Indi_2Parametter>(MarketData.GetBars(Exit1TimeFrame), Exit1IndiCalculationSelectionP2, Exit1IndiCalculationValue1P2, Exit1IndiCalculationValue2P2);
            exit1P4 = Indicators.GetIndicator<CSTP_Indi_4Parametter>(MarketData.GetBars(Exit1TimeFrame), Exit1IndiCalculationSelectionP4, Exit1IndiCalculationValue1P4, Exit1IndiCalculationValue2P4, Exit1IndiCalculationValue3P4, Exit1IndiCalculationMaTypeP4);
        ...
        private void Calulate()
        {
            ...
            // Exit
            if (Exit1IndiTraillingType != EnumExit1IndiTraillingType.None)
            {
        ...
        {
            var resultBaseline1P = FunctionSignalUnderOver(baseline1P1.Result, baseline1P1.Signal, Baseline1SignalTypeP1); // FunctionSignalUnderOver(DataSeries result, DataSeries Signal, EnumSignalOverUnderType signalOverUnder)
            var resultBaseline2P = FunctionSignalUnderOver(baseline1P2.Result, baseline1P2.Signal, Baseline1SignalTypeP2); // FunctionSignalUnderOver(DataSeries result, DataSeries Signal, EnumSignalOverUnderType signalOverUnder)
            var resultBaseline4P = FunctionSignalDoubleSignalUnderOver(baseline1P4.Result, baseline1P4.Signal, Baseline1SignalTypeP4, Baseline1LevelBuyP4, Baseline1LevelSellP4); // FunctionSignalDoubleSignalUnderOver(DataSeries result, DataSeries signal, EnumSignalDoubleOverUnderType signalOverUnder, double levelBuy, double levelSell)
            ...
            if (!Baseline1UseP1 && !Baseline1UseP2 && !Baseline1UseP4 && tradeType == TradeType.Buy)
                ...
                return -1;
            // with baseline
            else if ((!Baseline1UseP1 || resultBaseline1P == 1) && (!Baseline1UseP2 || resultBaseline2P == 1) && (!Baseline1UseP4 || resultBaseline4P == 1) && tradeType == TradeType.Buy) // add all variable with this sentence (exemple): (!Volume1MfiUse || resultMfi == 1)
                return 1;
            else if ((!Baseline1UseP1 || resultBaseline1P == -1) && (!Baseline1UseP2 || resultBaseline2P == -1) && (!Baseline1UseP4 || resultBaseline4P == -1) && tradeType == TradeType.Sell)
                return -1;
            else
                return 0;
        }
        ...
        {
            var resultEntry1P1 = FunctionSignalCrossEnter(entry1P1.Result, entry1P1.Signal, Entry1SignalTypeP1, double.NaN, double.NaN, Entry1LookBackMinP1); //FunctionSignalCrossEnter(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultEntry1P2 = FunctionSignalCrossEnter(entry1P2.Result, entry1P2.Signal, Entry1SignalTypeP2, double.NaN, double.NaN, Entry1LookBackMinP2); //FunctionSignalCrossEnter(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultEntry1P4 = FunctionSignalCrossEnter(entry1P4.Result, entry1P4.Signal, Entry1SignalTypeP4, Entry1LevelBuyP4, Entry1LevelSellP4, Entry1LookBackMinP4); //FunctionSignalCrossEnter(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            ...
            if (!Entry1UseP1 && !Entry1UseP2 && !Entry1UseP4 && tradeType == TradeType.Buy)
                ...
                return -1;
            // with Entry
            else if ((!Entry1UseP1 || resultEntry1P1 == 1) && (!Entry1UseP2 || resultEntry1P2 == 1) && (!Entry1UseP4 || resultEntry1P4 == 1) && tradeType == TradeType.Buy) // add all variable with this sentence (exemple): (!Entry1RsiUse || resultRsi == 1)
                return 1;
            else if ((!Entry1UseP1 || resultEntry1P1 == -1) && (!Entry1UseP2 || resultEntry1P2 == -1) && (!Entry1UseP4 || resultEntry1P4 == -1) && tradeType == TradeType.Sell)
                return -1;
            else
                return 0;
        }
        ...
        {
            var resultConfirmation1P1 = FunctionSignalUnderOver(confirmation1P1.Result, confirmation1P1.Signal, Confirmation1SignalTypeP1); // FunctionSignalUnderOver(DataSeries result, DataSeries Signal, EnumSignalOverUnderType signalOverUnder)
            var resultConfirmation1P2 = FunctionSignalUnderOver(confirmation1P2.Result, confirmation1P2.Signal, Confirmation1SignalTypeP2); // FunctionSignalUnderOver(DataSeries result, DataSeries Signal, EnumSignalOverUnderType signalOverUnder)
            var resultConfirmation1P4 = FunctionSignalDoubleSignalUnderOver(confirmation1P4.Result, confirmation1P4.Signal, Confirmation1SignalTypeP4, Confirmation1LevelBuyP4, Confirmation1LevelSellP4); //FunctionSignalCross(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            ...
            if (!Confirmation1UseP1 && !Confirmation1UseP2 && !Confirmation1UseP4 && tradeType == TradeType.Buy)
                ...
                return -1;
            // with Condirmation
            else if ((!Confirmation1UseP1 || resultConfirmation1P1 == 1) && (!Confirmation1UseP2 || resultConfirmation1P2 == 1) && (!Confirmation1UseP4 || resultConfirmation1P4 == 1) && tradeType == TradeType.Buy) // add all variable with this sentence : (!Confirmation1MacdUse || resultMacd == 1)
                return 1;
            else if ((!Confirmation1UseP1 || resultConfirmation1P1 == -1) && (!Confirmation1UseP2 || resultConfirmation1P2 == -1) && (!Confirmation1UseP4 || resultConfirmation1P4 == -1) && tradeType == TradeType.Sell)
                return -1;
            else
                return 0;
        }
        ...
        {
            var resultVolume1P4 = FunctionSignalDoubleSignalUnderOver(volume1P4.Result, volume1P4.Signal, Volume1SignalTypeP4, Volume1LevelBuyP4, Volume1LevelSellP4); //FunctionSignalCross(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultVolume2P4 = FunctionSignalDoubleSignalUnderOver(volume2P4.Result, volume2P4.Signal, Volume2SignalTypeP4, Volume2LevelBuyP4, Volume2LevelSellP4); //FunctionSignalCross(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultVolume3P4 = FunctionSignalDoubleSignalUnderOver(volume3P4.Result, volume3P4.Signal, Volume3SignalTypeP4, Volume3LevelBuyP4, Volume3LevelSellP4); //FunctionSignalCross(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            ...
            if (!Volume1UseP4 && !Volume2UseP4 && !Volume3UseP4 && tradeType == TradeType.Buy)
                ...
                return -1;
            // with Volume
            else if ((!Volume1UseP4 || resultVolume1P4 == 1) && (!Volume2UseP4 || resultVolume2P4 == 1) && (!Volume3UseP4 || resultVolume3P4 == 1) && tradeType == TradeType.Buy)  // add all variable with this sentence : (!Volume1MfiUse || resultMfi == 1)
                return 1;
            else if ((!Volume1UseP4 || resultVolume1P4 == -1) && (!Volume2UseP4 || resultVolume2P4 == -1) && (!Volume3UseP4 || resultVolume3P4 == -1) && tradeType == TradeType.Sell)
                return -1;
            else
                return 0;
        }
        ...
        private int GetExit1(TradeType tradeType) // all indicator adding on exit are implemented here
        {
            ...
            if (traillingSL)
            {
                ...
                {
                    var resultExit1P1 = FunctionCross(exit1P1.Result, exit1P1.Signal);
                ...
                if (Exit1IndiType == EnumExit1IndiType.Indicator_2_Parametters)
                {
                    var resultExit1P2 = FunctionCross(exit1P2.Result, exit1P2.Signal);
                ...
                if (Exit1IndiType == EnumExit1IndiType.Indicator_4_Parametters)
                {
                    var resultExit1P2 = FunctionCross(exit1P4.Result, exit1P4.Signal);
                    if ((resultExit1P2 == 1) && tradeType == TradeType.Sell) // add all variable with this sentence : (!Volume1MfiUse || resultMfi == 1)
                        return 1;
                    else if ((resultExit1P2 == -1) && tradeType == TradeType.Buy)
                        return -1;
        ...
        private int FunctionSignalUnderOver(DataSeries result, DataSeries Signal, EnumSignalOverUnderType signalOverUnder)
        {
            ...
            {
                if (result.Last(barsBack) > Signal.Last(barsBack))
                    return 1;
                else if (result.Last(barsBack) < Signal.Last(barsBack))
                    return -1;
                else
                    return 0;
            }
        ...
        private int FunctionSignalDoubleSignalUnderOver(DataSeries result, DataSeries signal, EnumSignalDoubleOverUnderType signalOverUnder, double levelBuy, double levelSell)
        {
            ...
            {
                if (result.Last(barsBack) > levelBuy)
                    return 1;
                else if (result.Last(barsBack) < levelSell)
                    return -1;
                else
                    return 0;
            }
            ...
            {
                if (result.Last(barsBack) > levelBuy && result.Last(barsBack) > signal.Last(barsBack))
                    return 1;
                else if (result.Last(barsBack) < levelSell && result.Last(barsBack) < signal.Last(barsBack))
                    return -1;
                else
                    return 0;
            }
        ...
        private int FunctionSignalCrossEnter(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
        {
            if (signalOverUnder == EnumSignalCrossType.Cross_On_Level)
            {
                //Print(result.Minimum((lookBack + barsBack)) + "             " + Bars.OpenTimes.Last(0));
                if (GetMinimum(result, (lookBack + barsBack)) <= levelBuy && result.Last(barsBack) > levelBuy)
                    return 1;
                else if (GetMaximum(result, (lookBack + barsBack)) >= levelSell && result.Last(barsBack) < levelSell)
                    return -1;
                else
                    return 0;
            }
            ...
            {
                if (GetSignalLookbackBuy(result, signal, lookBack + barsBack) && result.Last(barsBack) > signal.Last(barsBack))
                    return 1;
                else if (GetSignalLookbackSell(result, signal, lookBack + barsBack) && result.Last(barsBack) < signal.Last(barsBack))
                    return -1;
                else
                    return 0;
            }
            ...
            {
                if (GetMinimum(result, (lookBack + barsBack)) <= levelBuy && result.Last(barsBack) > levelBuy && signal.Last(barsBack) > signal.Last(barsBack))
                    return 1;
                else if (GetMaximum(result, (lookBack + barsBack)) >= levelSell && result.Last(barsBack) < levelSell && signal.Last(barsBack) < signal.Last(barsBack))
                    return -1;
                else
                    return 0;
            }
            ...
            {
                if (GetSignalLookbackBuy(result, signal, lookBack + barsBack) && result.Last(barsBack) > signal.Last(barsBack) && result.Last(barsBack) < levelBuy)
                    return 1;
                else if (GetSignalLookbackSell(result, signal, lookBack + barsBack) && result.Last(barsBack) < signal.Last(barsBack) && result.Last(barsBack) > levelSell)
                    return -1;
                else
                    return 0;
            }
        ...
        private double GetMinimum(DataSeries result, int lookBack)  // -> test if more faster than result.Minimum(lookBack +1)
        {
            ...
            for (int i = 1; i <= lookBack; i++)
                min = Math.Max(result.Last(i), min);
            return min;
        }
        ...
        private double GetSL(TradeType tradeType)
        {
            ...
            if (Exit1IndiType == EnumExit1IndiType.Indicator_1_Parametter)
            {
                if (tradeType == TradeType.Buy)
                    result = (Bars.ClosePrices.Last(1) - exit1P1.Result.Last(1)) / Symbol.PipSize;
                else
                    result = (exit1P1.Result.Last(1) - Bars.ClosePrices.Last(1)) / Symbol.PipSize;
            }
            else if (Exit1IndiType == EnumExit1IndiType.Indicator_2_Parametters)
            {
                if (tradeType == TradeType.Buy)
                    result = (Bars.ClosePrices.Last(1) - exit1P2.Result.Last(1)) / Symbol.PipSize;
                else
                    result = (exit1P2.Result.Last(1) - Bars.ClosePrices.Last(1)) / Symbol.PipSize;
            }

            else if (Exit1IndiType == EnumExit1IndiType.Indicator_4_Parametters)
            {
                if (tradeType == TradeType.Buy)
                    result = (Bars.ClosePrices.Last(1) - exit1P4.Result.Last(1)) / Symbol.PipSize;
                else
                    result = (exit1P4.Result.Last(1) - Bars.ClosePrices.Last(1)) / Symbol.PipSize;
            }
        ...
        private void Open(TradeType tradeType, string label)
        {
            ...
            TradeResult result = ExecuteMarketOrder(tradeType, SymbolName, tradeAmount, label, sl, tp == 0 ? null : tp, null, Exit1IndiTraillingType == EnumExit1IndiTraillingType.Standard_Trailling_Stop);

            if (Exit1IndiTraillingType != EnumExit1IndiTraillingType.None)
                traillingSLStart = tradeType == TradeType.Buy ? Bars.ClosePrices.Last(1) + ((sl * Symbol.PipSize) * Exit1IndiTraillingStart) : Bars.ClosePrices.Last(1) - ((sl * Symbol.PipSize) * Exit1IndiTraillingStart);
        ...
        private void Close(TradeType tradeType, string label)
        {
            ...
            ReinitialisationOnClose(lastPosition);
        }
        ...
        private bool CheckEntryConditions()
        {
            ...
            if ((Bars.OpenTimes.Last(0).ToLocalTime().Hour >= StartHour) && (Bars.OpenTimes.Last(0).ToLocalTime().Hour <= EndHour) && (chkDayofWeek == true) && (Symbol.Spread < (SpreadMax * Symbol.PipSize)) && !OnSleepPeriod())
            {
                return true;
            }
            else
        ...
        protected override void OnStop()
        {
            if (ExportData)
            {
                ...
                File.WriteAllText(pathAndFilename2, "Position" + ";" + "Account Balance" + ";" + "Profit" + ";" + "Profit Factor" + ";" + "Commission" + ";" + "Swap" + ";" + "Drawdown" + ";" + "Drawup" + ";" + "ConsecutiveWin" + ";" + "ConsecutiveLoss\r\n");
                ...
                var maxaccountBalance = double.MinValue;
                var maxagenetProfit = double.MinValue;
                var maxprofitFactor = double.MinValue;
                var maxcommission = double.MinValue;
                var maxswap = double.MinValue;
                var maxdrawdown = double.MinValue;
                var maxdrawup = double.MinValue;
                var maxconsecutiveWin = double.MinValue;
                var maxconsecutiveLoss = double.MinValue;

                var minaccountBalance = double.MaxValue;
                var minagenetProfit = double.MaxValue;
                var minprofitFactor = double.MaxValue;
                var mincommission = double.MaxValue;
                var minswap = double.MaxValue;
                var mindrawdown = double.MaxValue;
                var mindrawup = double.MaxValue;
                var minconsecutiveWin = double.MaxValue;
                var minconsecutiveLoss = double.MaxValue;

                for (i = 0; i < positionStat.Count; i++)
                {
                    File.AppendAllText(pathAndFilename2, positionStat[i][0] + ";" + positionStat[i][1] + ";" + positionStat[i][2] + ";" + positionStat[i][3] + ";" + positionStat[i][4] + ";" + positionStat[i][5] + ";" + positionStat[i][6] + ";" + positionStat[i][7] + ";" + positionStat[i][8] + ";" + positionStat[i][9] + "\r\n");
                ...
                File.AppendAllText(pathAndFilename2, "Average" + ";" + res0 + ";" + res1 + ";" + res2 + ";" + res3 + ";" + res4 + ";" + res5 + ";" + res6 + ";" + res7 + ";" + res8 + "\r\n\r\n");
                File.AppendAllText(pathAndFilename2, "Max" + ";" + maxaccountBalance + ";" + maxagenetProfit + ";" + maxprofitFactor + ";" + maxcommission + ";" + maxswap + ";" + maxdrawdown + ";" + maxdrawup + ";" + maxconsecutiveWin + ";" + maxconsecutiveLoss + "\r\n\r\n");
                File.AppendAllText(pathAndFilename2, "Min" + ";" + minaccountBalance + ";" + minagenetProfit + ";" + minprofitFactor + ";" + mincommission + ";" + minswap + ";" + mindrawdown + ";" + mindrawup + ";" + minconsecutiveWin + ";" + minconsecutiveLoss + "\r\n\r\n");
        ...
        protected override double GetFitness(GetFitnessArgs args)
        {
            ...
            int AccountSize = 100000;

            if (RatioProfiNet)
            {
                ratioProfiNet = args.TotalTrades == 0 ? 0 : args.Equity / AccountSize;
            }
            else if (!RatioProfiNet)
            {
                ratioProfiNet = 1;
            }
            if (RatioTpSl)
            {
                ratioTpSl = args.TotalTrades == 0 ? 0 : Exit1IndiType == EnumExit1IndiType.Sl_TP_Fixed ? RRR / Sl * SlMultiplier : args.History.Max(x => x.NetProfit) / Math.Abs(args.History.Min(x => x.NetProfit));
            }
            else if (!RatioTpSl)
            {
                ratioTpSl = 1;
            ...
            if (DrawdownMax)
            {
                drawdownEquity = args.MaxEquityDrawdownPercentages < 1 ? 10 :
                           args.MaxEquityDrawdownPercentages < 2 ? 5 :
                           args.MaxEquityDrawdownPercentages < 3 ? 2.5 :
                           args.MaxEquityDrawdownPercentages < 4 ? 1.25 :
                           args.MaxEquityDrawdownPercentages < 5 ? 1.125 :
                           args.MaxEquityDrawdownPercentages < 6 ? 1.0625 :
                           args.MaxEquityDrawdownPercentages < 7 ? 1.0625 :
                           args.MaxEquityDrawdownPercentages < 8 ? 1.03125 :
                           args.MaxEquityDrawdownPercentages < 9 ? 1.0161 :
                           args.MaxEquityDrawdownPercentages < 10 ? 1.008 :
                           args.MaxEquityDrawdownPercentages <= 10 ? 1 : 1;

                drawdownBalance = args.MaxBalanceDrawdownPercentages < 1 ? 10 :
                           args.MaxBalanceDrawdownPercentages < 2 ? 5 :
                           args.MaxBalanceDrawdownPercentages < 3 ? 2.5 :
                           args.MaxBalanceDrawdownPercentages < 4 ? 1.25 :
                           args.MaxBalanceDrawdownPercentages < 5 ? 1.125 :
                           args.MaxBalanceDrawdownPercentages < 6 ? 1.0625 :
                           args.MaxBalanceDrawdownPercentages < 7 ? 1.0625 :
                           args.MaxBalanceDrawdownPercentages < 8 ? 1.03125 :
                           args.MaxBalanceDrawdownPercentages < 9 ? 1.0161 :
                           args.MaxBalanceDrawdownPercentages < 10 ? 1.008 :
            ...
            if (PROM)
            {
                ...
                prom = args.TotalTrades == 0 ? 0 : (((AvgWinningTrade * (win - sqrtWins)) - (AvgLosingTrade * (losing - sqrtLosses))) / AccountSize) * 100;
            }
            if (!PROM)
            {
                prom = 1;
            ...
            if (args.NetProfit >= 0)
            {
                ...
                return (args.Equity - AccountSize);
        }
    }
}
