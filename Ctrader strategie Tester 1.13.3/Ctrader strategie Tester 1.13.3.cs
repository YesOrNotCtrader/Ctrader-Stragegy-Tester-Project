...
namespace cAlgo.Robots
{
    ...
    public class CtraderStrategieTesterv11 : Robot
    {
        ...
        [Parameter("Use it ?", DefaultValue = false, Group = "B1  => Indicator BB parametter")]
        public bool Baseline1UseBB { get; set; }
        [Parameter("     Value1", DefaultValue = 55, Group = "B1  => Indicator BB parametter", Step = 1)]
        public int Baseline1Value1BB { get; set; }
        [Parameter("     Value2", DefaultValue = 2, Group = "B1  => Indicator BB parametter")]
        public double Baseline1Value2BB { get; set; }
        [Parameter("     Moving Average Type", DefaultValue = MovingAverageType.Simple, Group = "B1  => Indicator BB parametter")]
        public MovingAverageType Baseline1MaTypeBB { get; set; }
        [Parameter("     Signal Type", DefaultValue = EnumConfirmationBB.Over_Top_Positive_Or_Under_Negative, Group = "B1  => Indicator BB parametter")]
        public EnumConfirmationBB Baseline1SignalTypeBB { get; set; }
        public enum EnumConfirmationBB
        {
            In_Range,
            Over_Top_Positive_Or_Under_Negative,
            Over_Top_Bands_Negative_Or_Under_Positive,
        }
        ...
        [Parameter("Use it ?", DefaultValue = false, Group = "E1  => Indicator BB parametter")]
        public bool Entry1UseBB { get; set; }
        [Parameter("     Value1", DefaultValue = 55, Group = "E1  => Indicator BB parametter", Step = 1)]
        public int Entry1Value1BB { get; set; }
        [Parameter("     Value2", DefaultValue = 2, Group = "E1  => Indicator BB parametter")]
        public double Entry1Value2BB { get; set; }
        [Parameter("     Moving Average Type", DefaultValue = MovingAverageType.Simple, Group = "E1  => Indicator BB parametter")]
        public MovingAverageType Entry1MaTypeBB { get; set; }
        [Parameter("     Signal Type", DefaultValue = EnumSignalBB.Over_Top_Positive_Or_Under_Negative, Group = "E1  => Indicator BB parametter")]
        public EnumSignalBB Entry1SignalTypeBB { get; set; }
        public enum EnumSignalBB
        {
            Over_Top_Positive_Or_Under_Negative,
            Over_Top_Bands_Negative_Or_Under_Positive,
        }
        ...
        [Parameter("Use it ?", DefaultValue = false, Group = "C1  => Indicator BB parametter")]
        public bool Confirmation1UseBB { get; set; }
        [Parameter("     Value1", DefaultValue = 55, Group = "C1  => Indicator BB parametter", Step = 1)]
        public int Confirmation1Value1BB { get; set; }
        [Parameter("     Value2", DefaultValue = 2, Group = "C1  => Indicator BB parametter")]
        public double Confirmation1Value2BB { get; set; }
        [Parameter("     Moving Average Type", DefaultValue = MovingAverageType.Simple, Group = "C1  => Indicator BB parametter")]
        public MovingAverageType Confirmation1MaTypeBB { get; set; }
        [Parameter("     Signal Type", DefaultValue = EnumConfirmationBB.In_Range, Group = "C1  => Indicator BB parametter")]
        public EnumConfirmationBB Confirmation1SignalTypeBB { get; set; }
        ...
        [Parameter("Use it ?", DefaultValue = false, Group = "V3  => Indicator BB parametter")]
        public bool Volume1UseBB { get; set; }
        [Parameter("     Value1", DefaultValue = 55, Group = "V3  => Indicator BB parametter", Step = 1)]
        public int Volume1Value1BB { get; set; }
        [Parameter("     Value2", DefaultValue = 2, Group = "V3  => Indicator BB parametter")]
        public double Volume1Value2BB { get; set; }
        [Parameter("     Moving Average Type", DefaultValue = MovingAverageType.Simple, Group = "V3  => Indicator BB parametter")]
        public MovingAverageType Volume1MaTypeBB { get; set; }
        [Parameter("     Signal Type", DefaultValue = EnumConfirmationBB.In_Range, Group = "V3  => Indicator BB parametter")]
        public EnumConfirmationBB Volume1SignalTypeBB { get; set; }
        ...
        protected override void OnStart()
        {
            ...
            baseline1BB = Indicators.BollingerBands(MarketData.GetBars(Baseline1TimeFrame).ClosePrices, Baseline1Value1BB, Baseline1Value2BB, Baseline1MaTypeBB);
            ...
            entry1BB = Indicators.BollingerBands(MarketData.GetBars(Entry1TimeFrame).ClosePrices, Entry1Value1BB, Entry1Value2BB, Entry1MaTypeBB);
            ...
            confirmation1BB = Indicators.BollingerBands(MarketData.GetBars(Confirmation1TimeFrame).ClosePrices, Confirmation1Value1BB, Confirmation1Value2BB, Confirmation1MaTypeBB);
            ...
            volume1BB = Indicators.BollingerBands(MarketData.GetBars(Volume1TimeFrame).ClosePrices, Volume1Value1BB, Volume1Value2BB, Volume1MaTypeBB);

            //exit
            exit1CalculationP1 = Indicators.GetIndicator<CSTP_Indi_1Parametter>(MarketData.GetBars(TimeFrame), Exit1CalculationSelectionP1, Exit1CalculationValue1P1);
            exit1CalculationP2 = Indicators.GetIndicator<CSTP_Indi_2Parametter>(MarketData.GetBars(TimeFrame), Exit1CalculationSelectionP2, Exit1CalculationValue1P2, Exit1CalculationValue2P2);
            exit1CalculationP4 = Indicators.GetIndicator<CSTP_Indi_4Parametter>(MarketData.GetBars(TimeFrame), Exit1CalculationSelectionP4, Exit1CalculationValue1P4, Exit1CalculationValue2P4, Exit1CalculationValue3P4, Exit1CalculationMaTypeP4);

            exit1TraillingP1 = Indicators.GetIndicator<CSTP_Indi_1Parametter>(MarketData.GetBars(TimeFrame), Exit1TraillingSelectionP1, Exit1TraillingValue1P1);
            exit1TraillingP2 = Indicators.GetIndicator<CSTP_Indi_2Parametter>(MarketData.GetBars(TimeFrame), Exit1TraillingSelectionP2, Exit1TraillingValue1P2, Exit1TraillingValue2P2);
            exit1TraillingP4 = Indicators.GetIndicator<CSTP_Indi_4Parametter>(MarketData.GetBars(TimeFrame), Exit1TraillingSelectionP4, Exit1TraillingValue1P4, Exit1TraillingValue2P4, Exit1TraillingValue3P4, Exit1TraillingMaTypeP4);
        ...
        private void Calulate()
        {
            ...
            var checkCondition = CheckEntryConditions();

            if (checkCondition && Signal(TradeType.Buy) == 1)
                Open(TradeType.Buy, botNameLabelBuy);
            if (checkCondition && Signal(TradeType.Sell) == -1)
                Open(TradeType.Sell, botNameLabelSell);

            // Exit
            if (Exit1TraillingType == EnumExit1IndiTraillingType.Indicator_1_Parametter || Exit1TraillingType == EnumExit1IndiTraillingType.Indicator_2_Parametters || Exit1TraillingType == EnumExit1IndiTraillingType.Indicator_4_Parametters)
            {
        ...
        {
            var resultBaseline1P = !Baseline1UseP1 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalUnderOver(tradeType, baseline1P1.Result, baseline1P1.Signal, Baseline1SignalTypeP1); // FunctionSignalUnderOver(DataSeries result, DataSeries Signal, EnumSignalOverUnderType signalOverUnder)
            var resultBaseline2P = !Baseline1UseP2 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalUnderOver(tradeType, baseline1P2.Result, baseline1P2.Signal, Baseline1SignalTypeP2); // FunctionSignalUnderOver(DataSeries result, DataSeries Signal, EnumSignalOverUnderType signalOverUnder)
            var resultBaseline4P = !Baseline1UseP4 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalDoubleSignalUnderOver(tradeType, baseline1P4.Result, baseline1P4.Signal, Baseline1SignalTypeP4, Baseline1LevelBuyP4, Baseline1LevelSellP4); // FunctionSignalDoubleSignalUnderOver(DataSeries result, DataSeries signal, EnumSignalDoubleOverUnderType signalOverUnder, double levelBuy, double levelSell)
            var resultBaselineBB = !Baseline1UseBB ? tradeType == TradeType.Buy ? 1 : -1 : FunctionConfirmationBB(tradeType, Bars.ClosePrices, baseline1BB.Top, baseline1BB.Bottom, Baseline1SignalTypeBB); //FunctionConfirmationBB(TradeType tradeType, DataSeries Bars, DataSeries BBTop, DataSeries BBBottom, EnumConfirmationBB signalOverUnder)

            if ((resultBaseline1P == 1) && (resultBaseline2P == 1) && (resultBaseline4P == 1) && (resultBaselineBB == 1)) // add all variable with this sentence (exemple): (!Volume1MfiUse || resultMfi == 1)
                return 1;
            else if ((resultBaseline1P == -1) && (resultBaseline2P == -1) && (resultBaseline4P == -1) && (resultBaselineBB == -1))
                return -1;
            else
                return 0;
        }
        ...
        {
            var resultEntry1P1 = !Entry1UseP1 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalCrossEnter(tradeType, entry1P1.Result, entry1P1.Signal, Entry1SignalTypeP1, double.NaN, double.NaN, Entry1LookBackMinP1); //FunctionSignalCrossEnter(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultEntry1P2 = !Entry1UseP2 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalCrossEnter(tradeType, entry1P2.Result, entry1P2.Signal, Entry1SignalTypeP2, double.NaN, double.NaN, Entry1LookBackMinP2); //FunctionSignalCrossEnter(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultEntry1P4 = !Entry1UseP4 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalCrossEnter(tradeType, entry1P4.Result, entry1P4.Signal, Entry1SignalTypeP4, Entry1LevelBuyP4, Entry1LevelSellP4, Entry1LookBackMinP4); //FunctionSignalCrossEnter(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultEntry1BB = !Entry1UseBB ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalBB(tradeType, Bars.ClosePrices, entry1BB.Top, entry1BB.Bottom, Entry1SignalTypeBB); //FunctionSignalBB(TradeType tradeType, DataSeries Bars, DataSeries BBTop, DataSeries BBBottom, EnumConfirmationBB signalOverUnder)
                                                                                                                                                                                        // without Entry
            if ((resultEntry1P1 == 1) && (resultEntry1P2 == 1) && (resultEntry1P4 == 1) && (resultEntry1BB == 1)) // add all variable with this sentence (exemple): (!Entry1RsiUse || resultRsi == 1)
                return 1;
            else if ((resultEntry1P1 == -1) && (resultEntry1P2 == -1) && (resultEntry1P4 == -1) && (resultEntry1BB == -1))
                return -1;
            else
                return 0;
        }
        ...
        {
            var resultConfirmation1P1 = !Confirmation1UseP1 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalUnderOver(tradeType, confirmation1P1.Result, confirmation1P1.Signal, Confirmation1SignalTypeP1); // FunctionSignalUnderOver(DataSeries result, DataSeries Signal, EnumSignalOverUnderType signalOverUnder)
            var resultConfirmation1P2 = !Confirmation1UseP2 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalUnderOver(tradeType, confirmation1P2.Result, confirmation1P2.Signal, Confirmation1SignalTypeP2); // FunctionSignalUnderOver(DataSeries result, DataSeries Signal, EnumSignalOverUnderType signalOverUnder)
            var resultConfirmation1P4 = !Confirmation1UseP4 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalDoubleSignalUnderOver(tradeType, confirmation1P4.Result, confirmation1P4.Signal, Confirmation1SignalTypeP4, Confirmation1LevelBuyP4, Confirmation1LevelSellP4); //FunctionSignalCross(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultConfirmation1BB = !Confirmation1UseBB ? tradeType == TradeType.Buy ? 1 : -1 : FunctionConfirmationBB(tradeType, Bars.ClosePrices, confirmation1BB.Top, confirmation1BB.Bottom, Confirmation1SignalTypeBB); //FunctionConfirmationBB(TradeType tradeType, DataSeries Bars, DataSeries BBTop, DataSeries BBBottom, EnumConfirmationBB signalOverUnder)

            if ((resultConfirmation1P1 == 1) && (resultConfirmation1P2 == 1) && (resultConfirmation1P4 == 1) && (resultConfirmation1BB == 1)) // add all variable with this sentence : (!Confirmation1MacdUse || resultMacd == 1)
                return 1;
            else if ((resultConfirmation1P1 == -1) && (resultConfirmation1P2 == -1) && (resultConfirmation1P4 == -1) && (resultConfirmation1BB == -1))
                return -1;
            else
                return 0;
        }
        ...
        {
            var resultVolume1P4 = !Volume1UseP4 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalDoubleSignalUnderOver(tradeType, volume1P4.Result, volume1P4.Signal, Volume1SignalTypeP4, Volume1LevelBuyP4, Volume1LevelSellP4); //FunctionSignalCross(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultVolume2P4 = !Volume2UseP4 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalDoubleSignalUnderOver(tradeType, volume2P4.Result, volume2P4.Signal, Volume2SignalTypeP4, Volume2LevelBuyP4, Volume2LevelSellP4); //FunctionSignalCross(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultVolume3P4 = !Volume3UseP4 ? tradeType == TradeType.Buy ? 1 : -1 : FunctionSignalDoubleSignalUnderOver(tradeType, volume3P4.Result, volume3P4.Signal, Volume3SignalTypeP4, Volume3LevelBuyP4, Volume3LevelSellP4); //FunctionSignalCross(DataSeries result, DataSeries signal, EnumSignalCrossType signalOverUnder, double levelBuy, double levelSell, int lookBack)
            var resultVolumeBB = !Volume1UseBB ? tradeType == TradeType.Buy ? 1 : -1 : FunctionConfirmationBB(tradeType, Bars.ClosePrices, volume1BB.Top, volume1BB.Bottom, Volume1SignalTypeBB); //FunctionConfirmationBB(TradeType tradeType, DataSeries Bars, DataSeries BBTop, DataSeries BBBottom, EnumConfirmationBB signalOverUnder)

            if ((resultVolume1P4 == 1) && (resultVolume2P4 == 1) && (resultVolume3P4 == 1) && (resultVolumeBB == 1))  // add all variable with this sentence : (!Volume1MfiUse || resultMfi == 1)
                return 1;
            else if ((resultVolume1P4 == -1) && (resultVolume2P4 == -1) && (resultVolume3P4 == -1) && (resultVolumeBB == -1))
                return -1;
            else
                return 0;
        }
        private int GetExit1(TradeType tradeType) // all indicator adding on exit are implemented here
        {
            ...
            if (traillingSL)
            {
                ...
                else if (Exit1TraillingType == EnumExit1IndiTraillingType.Indicator_2_Parametters)
                {
                ...
                else if (Exit1TraillingType == EnumExit1IndiTraillingType.Indicator_4_Parametters)
                {
        ...
        // FUNCTION FOR BB 
        // Confirmation Type Function
        private int FunctionConfirmationBB(TradeType tradeType, DataSeries Bars, DataSeries BBTop, DataSeries BBBottom, EnumConfirmationBB signalOverUnder)
        {
            if (signalOverUnder == EnumConfirmationBB.In_Range)
            {
                if (tradeType == TradeType.Buy && Bars.Last(barsBack) > BBBottom.Last(barsBack) && Bars.Last(barsBack) < BBTop.Last(barsBack))
                    return 1;
                else if (tradeType == TradeType.Sell && Bars.Last(barsBack) > BBBottom.Last(barsBack) && Bars.Last(barsBack) < BBTop.Last(barsBack))
                    return -1;
                else
                    return 0;
            }
            else if (signalOverUnder == EnumConfirmationBB.Over_Top_Positive_Or_Under_Negative)
            {
                if (tradeType == TradeType.Buy && Bars.Last(barsBack) > BBTop.Last(barsBack))
                    return 1;
                else if (tradeType == TradeType.Sell && Bars.Last(barsBack) < BBBottom.Last(barsBack))
                    return -1;
                else
                    return 0;
            }
            else // EnumConfirmationBB.Over_Top_Bands_Negative_Or_Under_Positive
            {
                if (tradeType == TradeType.Buy && Bars.Last(barsBack) < BBBottom.Last(barsBack))
                    return 1;
                else if (tradeType == TradeType.Sell && Bars.Last(barsBack) > BBTop.Last(barsBack))
                    return -1;
                else
                    return 0;
            }
        ...
        private int FunctionSignalBB(TradeType tradeType, DataSeries Bars, DataSeries BBTop, DataSeries BBBottom, EnumSignalBB signalOverUnder)
        {
            if (signalOverUnder == EnumSignalBB.Over_Top_Positive_Or_Under_Negative)
            {
                if (tradeType == TradeType.Buy && Bars.Last(barsBack) > BBTop.Last(barsBack) && Bars.Last(barsBack + 1) <= BBTop.Last(barsBack + 1))
                    return 1;
                else if (tradeType == TradeType.Sell && Bars.Last(barsBack) < BBBottom.Last(barsBack) && Bars.Last(barsBack + 1) >= BBBottom.Last(barsBack + 1))
                    return -1;
                else
                    return 0;
            }
            ...
            {
                if (tradeType == TradeType.Buy && Bars.Last(barsBack) > BBBottom.Last(barsBack) && Bars.Last(barsBack + 1) <= BBBottom.Last(barsBack + 1))
                    return 1;
                else if (tradeType == TradeType.Sell && Bars.Last(barsBack) < BBTop.Last(1) && Bars.Last(barsBack + 1) >= BBTop.Last(barsBack + 1))
                    return -1;
                else
                    return 0;
            }
        ...
        private double GetSL(TradeType tradeType)
        {
            ...
            if (Exit1IndiType == EnumExit1IndiType.Indicator_1_Parametter)
            {
                if (tradeType == TradeType.Buy)
                    result = (Bars.ClosePrices.Last(1) - exit1CalculationP1.Result.Last(1)) / Symbol.PipSize * SlMultiplier;
                else
                    result = (exit1CalculationP1.Result.Last(1) - Bars.ClosePrices.Last(1)) / Symbol.PipSize * SlMultiplier;
            }
            else if (Exit1IndiType == EnumExit1IndiType.Indicator_2_Parametters)
            {
                if (tradeType == TradeType.Buy)
                    result = (Bars.ClosePrices.Last(1) - exit1CalculationP2.Result.Last(1)) / Symbol.PipSize * SlMultiplier;
                else
                    result = (exit1CalculationP2.Result.Last(1) - Bars.ClosePrices.Last(1)) / Symbol.PipSize * SlMultiplier;
            }

            else if (Exit1IndiType == EnumExit1IndiType.Indicator_4_Parametters)
            {
                if (tradeType == TradeType.Buy)
                    result = (Bars.ClosePrices.Last(1) - exit1CalculationP4.Result.Last(1)) / Symbol.PipSize * SlMultiplier;
                else
                    result = (exit1CalculationP4.Result.Last(1) - Bars.ClosePrices.Last(1)) / Symbol.PipSize * SlMultiplier;
            }

            else if (Exit1IndiType == EnumExit1IndiType.Swing)
            {
                if (tradeType == TradeType.Buy)
                    result = (Bars.ClosePrices.Last(1) - Bars.ClosePrices.Minimum((int)Sl)) / Symbol.PipSize * SlMultiplier;
                else
                    result = (Bars.ClosePrices.Maximum((int)Sl) - Bars.ClosePrices.Last(1)) / Symbol.PipSize * SlMultiplier;
            }
            else if (Exit1IndiType == EnumExit1IndiType.Sl_TP_Fixed)
            {
                result = (Sl) * SlMultiplier;
            }
        ...
        protected override double GetFitness(GetFitnessArgs args)
        {
            ...
            if (DrawdownEquityMax)
            {
                drawdownEquity = args.MaxEquityDrawdownPercentages < 1 ? 5 :
                           ...
                           args.MaxEquityDrawdownPercentages >= 10 ? 0 : 1;
            }
            if (DrawdownBalanceMax)
            {
                drawdownBalance = args.MaxBalanceDrawdownPercentages < 1 ? 5 :
                         ...
                         args.MaxBalanceDrawdownPercentages >= 10 ? 0 : 1;
            }
