...
namespace cAlgo
{
    ...
    public class CSTP_Indi_1ParametterHTF : Indicator
    {
        [Parameter("TimeFrame", DefaultValue = "Daily", Group = "Calculation Type")]
        public TimeFrame TF1 { get; set; }

        [Parameter(DefaultValue = CSTP_Indi_1Parametter.EnumIndiSelection.Exponetial_Moving_Average)]
        public CSTP_Indi_1Parametter.EnumIndiSelection IndicatorSelection { get; set; }
        ...
        private CSTP_Indi_1Parametter cstp;
        private Bars bars1;
        ...
        protected override void Initialize()
        {
            ...
            cstp = Indicators.GetIndicator<CSTP_Indi_1Parametter>(bars1, IndicatorSelection, Period);
        }
