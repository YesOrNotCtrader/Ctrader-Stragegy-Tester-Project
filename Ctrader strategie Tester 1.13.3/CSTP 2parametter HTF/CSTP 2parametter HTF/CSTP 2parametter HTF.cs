...
namespace cAlgo
{
    ...
    public class CSTP_Indi_2ParametterHTF : Indicator
    {
        ...
        [Parameter(DefaultValue = CSTP_Indi_2Parametter.EnumIndiSelection.SuperTrend)]
        public CSTP_Indi_2Parametter.EnumIndiSelection IndicatorSelection { get; set; }
        ...
        private CSTP_Indi_2Parametter cstp;
        private Bars bars1;
        ...
        protected override void Initialize()
        {
            ...
            cstp = Indicators.GetIndicator<CSTP_Indi_2Parametter>(bars1, IndicatorSelection, Value1, Value2);
        }
